...
export const DocumentImportForm: React.FC = () => {
      ...
      if (template) {
        ...
        createDocumentFromTemplate(documentData, {
          onSuccess: (newDocument) => {
            // Redirect to OnlyOffice editor page with the new document ID
            navigate(`/documents/edit-onlyoffice/${newDocument.id}`);
          },
          onError: (error) => {
  ...
  const isTemplateSelected = selectedTemplateId && selectedTemplateId !== 'none';
  const isDirectFileUpload = selectedFile !== null;
    ...
    <form onSubmit={handleFileSubmit} className="space-y-6">
      <div className="space-y-2">
        ...
        <Select
          ...
          disabled={isLoadingTemplates || isDirectFileUpload} // Disable if direct file is selected
        >
          <SelectTrigger>
      ...
      <div className="flex justify-end space-x-4">
        ...
        >
          ...
          {isCreating || isUploadingFile ? 'Import...' : (isTemplateSelected ? 'Créer et Éditer' : 'Importer et Enregistrer')}
        </Button>
      </div>
    </form>
  );
